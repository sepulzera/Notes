package de.sepulzera.notes.ui.activity.pref;
...
public class SettingsActivity extends AppCompatPreferenceActivity {
  ...
  public static class GeneralPreferenceFragment extends PreferenceFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      // guidelines.
      bindPreferenceSummaryToValue(findPreference(getResources().getString(R.string.PREF_REV_DELETE_OLD_NUM_KEY)));
      bindPreferenceSummaryToValue(findPreference(getResources().getString(R.string.PREF_NOTE_REMOVE_DELETED_DAYS_NUM_KEY)));
